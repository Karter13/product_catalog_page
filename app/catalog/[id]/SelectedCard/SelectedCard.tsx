...
export const SelectedCard = ({ product }: SelectedCardProps) => {
  ...
  return (
    <div className="flex flex-col items-center gap-6 pb-8">
      ...
      <Card className="w-full max-w-lg border-2 border-green-500 bg-green-50 shadow-lg hover:shadow-2xl transition-shadow duration-300 rounded-xl">
        <CardHeader>
      ...
      <Link href="/catalog" className="w-full max-w-lg">
        <Button className="w-full bg-gray-500 hover:bg-gray-600 active:bg-gray-700 text-white font-medium cursor-pointer">
          В каталог
        </Button>
      </Link>
    </div>
